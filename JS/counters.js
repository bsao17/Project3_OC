...
class Counter {
    ...
    setCounter(){
        ...
        this.intervalId = setInterval(()=>{
            ...
            this.display.innerHTML = Math.floor(counterMinutes/60) + " min " + (counterSeconds) + " sec ";
    ...
    counterContinue(){
        ...
        this.intervalId = setInterval (()=>{
            ...
            this.display.innerHTML = Math.floor((storageMinutes--)/60) + ' mns et ' + (storageSeconds--) + ' sec';
